...
export default function Lightbox({ images, initialIndex, onClose, zIndex = 50 }: LightboxProps) {
  ...
  const slideVariants = {
    ...
    center: { x: 0, opacity: 1, transition: { duration: 0.4, ease: easings.cinematic } },
    exit: (d: number) => ({ x: d < 0 ? 280 : -280, opacity: 0, transition: { duration: 0.3, ease: easings.cinematic } }),
  };
