...
export default function Hero({ onChaptersClick }: HeroProps) {
  return (
    <motion.section
    ...
    >
      ...
      {/* Nav button — chapters */}
      <motion.button
        className="fixed z-10 flex items-center justify-center cursor-pointer transition-colors duration-300"
        initial={{ opacity: 0, y: 30 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 1, ease: easings.cinematic, delay: 1.2 }}
